              ...
              <div class="widget_box about_widget">
                ...
                <p>
                  @if (strlen(convertUtf8($bs->footer_text)) > 140)
                    {{ substr(convertUtf8($bs->footer_text), 0, 140) }}<span
                      style="display: none;">{{ substr(convertUtf8($bs->footer_text), 140) }}</span>
              ...
              <div class="widget_box newsletter_box">
                ...
                <form id="footerSubscribeForm" action="{{ route('front.subscribe') }}" method="post">
                  ...
                  <div class="form_group">
                    <input type="email" class="form_control" placeholder="{{ __('Enter Email Address') }}"
                      name="email" required>
