...
<head>
    ...
    <link href="{{ url('/') }}/assets/front/css/common-base-color.php?color={{ $bs->base_color }}"
        rel="stylesheet">
    <!-- base color change -->
    <link href="{{ url('/') }}/assets/front/css/construction-base-color.php?color={{ $bs->base_color }}"
        rel="stylesheet">
...
<body @if ($rtl == 1) dir="rtl" @endif>
    ...
    @if (!request()->routeIs('front.index') && !request()->routeIs('front.packageorder.confirmation'))
        ...
        <div class="breadcrumb-area lazy" data-bg="{{ asset('assets/front/img/' . $bs->breadcrumb) }}"
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="widget_box about_widget">
                                <img data-src="{{ asset('assets/front/img/' . $bs->footer_logo) }}"
                                    class="img-fluid lazy" alt="">
                                <p>
                                    @if (strlen(convertUtf8($bs->footer_text)) > 170)
                                        {{ substr(convertUtf8($bs->footer_text), 0, 170) }}<span
                                            style="display: none;">{{ substr(convertUtf8($bs->footer_text), 170) }}</span>
                            ...
                            <div class="widget_box contact_widget">
                                ...
                                <p>
                                    ...
                                    @foreach ($addresses as $address)
                                        {{ $address }}
                                        @if (!$loop->last)
                                            <br><span class="base-color"><i class="fas fa-map-marker-alt"></i></span>
                                        @endif
                                    @endforeach
                                </p>
