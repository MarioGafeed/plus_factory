            ...
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-lg-9 col-md-9 col-sm-9">
                    <div class="mt-30 text-left">
                        <img class="lazy" data-src="{{ asset('assets/front/img_product/' . $category_id . '.jpg') }}"
                            alt="">
                    </div>
                </div>
            </div>
                                ...
                                <ul>
                                    @foreach ($categories as $category)
                                        <li
                                            ...
                                            <a data-href="{{ $category->id }}"
                                                class="category-id cursor-pointer">{{ $category->name }}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="shop-item">
                                        <div class="shop-thumb">
                                            <img class="lazy"
                                                data-src="{{ asset('assets/front/img/product_categories/' . $category->name . '.jpg') }}"
                                                alt="" height="175">
                                            <ul>                                               
                        ...
                        @else
                            <div class="col-12 text-center py-5 bg-light" style="margin-top: 30px;">
                                <h4 class="text-center">{{ __('Category Not Found') }}</h4>
                            </div>
                        @endif
                    </div>
    ...
    @if ($bex->catalog_mode == 0)
        ...
        <script>
            ...
            $("#slider-range").slider({
                ...
                min: 0,
                max: '{{ $maxprice }}',
                values: ['{{ !empty(request()->input('minprice')) ? request()->input('minprice') : $minprice }}',
